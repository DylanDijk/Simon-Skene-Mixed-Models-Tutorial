...
Importing the dataset, and converting a selection of variables to factors.
**Need to select way for people to download file, should just make Github repo with csv file.**
