...
The best way to show how to calculate the modified box corrected F statistic is through an example.
Here we show present the code used by Simon Skene to calculate the results given in his paper.
